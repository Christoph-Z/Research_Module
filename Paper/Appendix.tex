...
CV <- function(n_v, y, X, Alpha = NULL, MonteCarlo = NULL, Replacement = FALSE, BICV = NULL ){  #n_v = #leaved out data points
	...
	#Alpha        Set of possible Modelvaritaions for which the CV should be calculated, by Default use all possible Models
...
d <-data.frame("C"=Crit,"M"=Model,
	"P"=c(0.5980,0.6015,0.9510,0.9690,0.3366,0.3320,0.048988,0.0305,0.0590,0.0590,0,0.0005,0.007,0.007,0,0),
	"COL"=rep("blue",16),"Prozent"=c("60%","60%","95%","97%","34%","33%","4%","3%","6%","6%","0%","0%","0.7%","0.8%","0%","0%"))
...
#b is the number of samplepartions
