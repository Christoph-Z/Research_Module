...
\begin{align}
\Gamma_{\alpha,n}=\sigma^2+n^{-1}d_\alpha\sigma^2+\vartriangle_{\alpha,n} \label{GAMMA_ALPHA}
\end{align}
with
\begin{align*}
\begin{tabular}{ll}
...
\end{tabular}
\end{align*}
This expression (\ref{GAMMA_ALPHA}) will be estimated by our model selection method we introduce in the next chapter. 
