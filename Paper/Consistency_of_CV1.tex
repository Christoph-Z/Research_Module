...
We capture the asymptotic properties of $CV(1)$ in the following theorem based on \cite{shao}\footnote{Proof of Theorem \ref{THM_Consistency of $CV(1)$} is given in Appendix A.3}.
